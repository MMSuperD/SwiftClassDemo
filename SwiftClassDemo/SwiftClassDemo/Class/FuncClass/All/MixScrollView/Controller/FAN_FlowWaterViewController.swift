//
//  FAN_FlowWaterViewController.swift
//  SwiftClassDemo
//
...
class FAN_FlowWaterViewController: FAN_BaseViewController {

    override func viewDidLoad() {
        super.viewDidLoad()
        addChildView()
        nvView.isHidden = true
    }
...
extension FAN_FlowWaterViewController: UICollectionViewDelegate,UICollectionViewDataSource {
